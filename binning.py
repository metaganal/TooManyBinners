...
class Binner:
    ...
    def run_vamb(self, output_directory):
        ...
        create_fasta_args = ['python3', 'create_fasta.py', '--fastapath', self.contigs_path, '--clusterspath', f"{output_directory}/results/vae_clusters.tsv", '--outdir', f"{output_directory}/bins/"]
